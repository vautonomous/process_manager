#ifndef UI_PROCESS_MANAGER_SECOND_HPP
#define UI_PROCESS_MANAGER_SECOND_HPP
...
class UIProcessManagerSecond : public rclcpp::Node {
public:
    UIProcessManagerSecond(const rclcpp::NodeOptions &options);
  ~UIProcessManagerSecond() override;
...
private:
    ...
    State node_state_{State::DISACTIVED};
...
#endif //UI_PROCESS_MANAGER_SECOND_HPP
